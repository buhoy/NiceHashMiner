...
Note that the project has been upgraded to Visual Studio 2017. This shouldn't be a problem for those running Windows 10 but if you run into problems with dll's missing open an issue and I'll help. First try downloading [Visual C++ Redistributable 2017](https://go.microsoft.com/fwlink/?LinkId=746572).
